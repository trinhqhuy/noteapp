  ...
  return (
    <>
      <div id="default-carousel" className="relative" data-carousel="static">
          ...
          ({ id, src, alt, title }) =>
            statusImage == id && (
              <div
                ...
                <div className="text-xl font-semibold text-black sm:text-xl dark:text-white hidden sm:hidden md:contents lg:contents xl:contents 2xl:contents">
                  {title}
                </div>
              </div>
            )
        ...
        <button
          type="button"
          onClick={() => onChangeStatusImageNext()}
